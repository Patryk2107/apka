...
namespace SavingFileApi.Services
{
    public class LoginService : ConnectionService, ILoginService
    {
        ...
        public LoginService(SavingFileDbContext context, IPasswordHasher<User> passwordHasher, AuthenticationOptions authenticationSettings) : base(context)
        {
