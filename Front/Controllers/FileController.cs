...
namespace Front.Controllers
{
    public class FileController : Controller
    {
        ...
        public async Task<IActionResult> UploadedFile()
        {
            ...
            var response = await _crudService.SearchNoAuth<FileSearchModel, FileModel>(url, fileModel);

            return View(response);
        }

        [HttpPost]
        public async Task<IActionResult> Index([Bind("Email, FileName")] FileSearchModel model)
        {
            ...
            var response = await _crudService.SearchNoAuth<FileSearchModel, FileModel>(url, model);
        ...
        public async Task<IActionResult> UploadFile(FileModel model)
        {
            ...
            var response = await _crudService.CreateNoLogin(url, model);
